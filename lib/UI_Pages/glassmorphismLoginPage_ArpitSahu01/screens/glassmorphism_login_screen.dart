        ...
        body:  Stack(
          children: [
            Positioned(child: Container(
              ...
              child: FittedBox(
                child: Image(image: AssetImage('assets/glassmorphism_ArpitSahu01/glassmorphismImage.jpg')),
                fit: BoxFit.cover,
              ),
            ),
            ),
                ...
                child: GlassmorphicContainer(
                  ...
                  child: Center(
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          Text('WELCOME', style: TextStyle(color: Colors.purple[700],fontWeight: FontWeight.bold,fontSize: 30),),
                          Spacer(),
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: Color.fromARGB(119, 227, 222, 223),
                            ),
                            child: TextField(
                              controller: null,
